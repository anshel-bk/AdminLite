...
Логика в задании разбита на два файла, сам парсер продублирован и находится в папке services либо api, визуал админки находится в django-adminlte3-master
